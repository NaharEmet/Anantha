    ...
    try:
        ...
        with gzip.open(filepath, 'rt', encoding='utf-8') as f:
            ...
            disaster_types = ['Hurricane', 'Tornado', 'Flood', 'Drought', 
                            ...
                            'Flash Flood', 'Heavy Snow', 'Heavy Rain']
...
def merge_with_existing_dataset(new_events):
    ...
    existing_file = 'full_disaster_dataset_all_storms.csv'
    ...
    combined_output_file = 'full_disaster_dataset_complete.csv'
...
def main():
    # Download and process storm data for missing years (2000-2023)
    missing_years = [str(year) for year in range(2000, 2024)]
    ...
    # Filter out years we already have
    years_to_download = [year for year in missing_years if year not in existing_years]
